...
<div id="loading-overlay" class="fixed inset-0 bg-white flex items-center justify-center z-50 transition-all">
  <div class="spinner-border animate-spin rounded-full border-4 border-t-4 border-black w-16 h-16"></div>
</div>
